/**
 * Name - Vaughan Pelletier
 * Teacher - Mr.Hardman
 * Program - PTEC
 * Date Last Worked On - 11/25/2018
 * 
 */
...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        if(turnNumber == 0)
        {
            ...
            playerOneName = JOptionPane.showInputDialog((null),"user enter","input box",JOptionPane.QUESTION_MESSAGE);
            ...
            playerTwoName = JOptionPane.showInputDialog((null),"user enter","input box",JOptionPane.QUESTION_MESSAGE);
